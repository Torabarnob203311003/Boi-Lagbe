            ...
            <nav className="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
                <div className="flex flex-wrap items-center justify-between max-w-screen-2xl px-4 mx-auto">
                    ...
                    <div className="flex items-center lg:order-2">
                        <a href=""
                            className="text-white bg-green-600 hover:bg-purple-800 focus:ring-4 focus:ring-cyan-500 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800 mr-3 md:mr-4 lg:mr-5">Sign In</a>
                        <a href=""
                            className="text-white bg-cyan-500 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">Sign Up</a>
                    </div>
